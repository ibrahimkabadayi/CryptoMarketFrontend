  ...
  <div class="animated-bg min-h-screen flex items-center justify-center p-4">
    ...
    <div class="glass-card w-full max-w-md p-10 animate-fade-in-up relative z-10">
      ...
      <div class="text-center mb-8 animate-fade-in-up animate-delay-1">
        ...
        <h1 class="text-3xl font-bold gradient-text mb-2 tracking-tight">Create Account</h1>
        <p class="text-sm" style="color: var(--text-secondary)">Join CryptoMarket today</p>
      </div>
      ...
      <form @submit.prevent="handleRegister" class="space-y-4">
        ...
        <button
            type="submit"
            :disabled="isLoading"
            class="btn-gradient w-full py-3.5 mt-2 text-base rounded-xl flex justify-center items-center animate-fade-in-up animate-delay-4"
        >
      ...
      <div class="mt-8 text-center text-sm animate-fade-in-up animate-delay-5" style="color: var(--text-muted)">
        ...
        <router-link to="/login" class="font-semibold transition-colors ml-1 auth-link-accent">Sign In</router-link>
      </div>
    </div>
  </div>
</template>
